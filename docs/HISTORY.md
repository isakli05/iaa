...
- **2026-08-26 17:39–17:54** — MAO v0 installed for Codex CLI 0.149.1, Claude Code 2.1.246,
...
- **2026-08-27 00:55–06:28 — Campaign 1 (collision smoke test).** First behavioral test of
  MAO vs co-loaded SDD on glm-5.3: MAO kept topology authority; SDD's review cadence and
...
- **2026-08-27 10:24–15:22 — Campaign 2 (structural archfix, v1→v2).** "Orchestration
  ...
  SDD never loads in MAO mode (3/3), native opt-in intact (15 agents). PASS (ADR-0002).
...
- **2026-09-06** — production usage: LCO fifth-audit program executed under MAO adaptive
